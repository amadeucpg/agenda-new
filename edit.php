...
<div class="container">
  ...
  <h1 id="main-title">Editar contatoooo!</h1>
  <form id="create-form" action="<?= $BASE_URL ?>config/process.php" method="POST">
    ...
    <div class="form-group">
      ...
      <select class="form-control" id="tipo" name="tipo" placeholder="Digite o tipo" required>
        <option value=""><?= $contact["tipo"]; ?></option>
        <?php foreach ($tabelatipos as $tabelatipo): ?>
          <option value="<?= $tabelatipo["tipo_contato"] ?>"><?= $tabelatipo["tipo_contato"] ?></option>
        <?php endforeach; ?>
      </select>
    </div>
    <div class="form-group">
